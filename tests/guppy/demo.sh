...
rm -rf test_* epca_* squash_* demulti_* islands_* round_* density.*
rm -f *.jplace
...
# Test `guppy epca`.
guppy epca --prefix epca_ $all_placefiles
guppy epca --prefix epca_ --out-dir test $all_placefiles
guppy epca --prefix epca_ --min-fat .5 $all_placefiles
guppy epca --prefix epca_ --min-fat 0 $all_placefiles
guppy epca --prefix epca_ --total-width 500 $all_placefiles
guppy epca --prefix epca_ --node-numbers $all_placefiles
guppy epca --prefix epca_ --width-factor 2 $all_placefiles
guppy epca --prefix epca_ --gray-black $all_placefiles
guppy epca --prefix epca_ --min-width 2 $all_placefiles
guppy epca --prefix epca_ --write-n 4 $all_placefiles
guppy epca --prefix epca_ --scale $all_placefiles
guppy epca --prefix epca_ --symmv $all_placefiles
guppy epca --prefix epca_ --kappa 0 $all_placefiles
guppy epca --prefix epca_ --kappa 0.5 $all_placefiles
guppy epca --prefix epca_ --kappa 1 $all_placefiles
guppy epca --prefix epca_ --rep-edges 0.3 $all_placefiles
guppy epca --prefix epca_ --rep-edges 0.5 $all_placefiles
guppy epca --prefix epca_ --epsilon 1e-4 $all_placefiles
